...
<div class="row">
    <div class="col-md-12">
        <table id="idListe" class="table table-bordered table-hover datatable display">
            <thead>
                <tr>
                    <th>{t}Individu{/t}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br>{$data[lst].traitementpiece_libelle}
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="center">{$data[lst].photo_width}x{$data[lst].photo_height}</div>
                    </td>
                    <td>{$data[lst].photo_date}</td>
                    <td>
                        <div class="center">{$data[lst].long_reference}</div>
                    </td>
                    <td>{$data[lst].lecteur_prenom} {$data[lst].lecteur_nom}</td>
                    <td>
                        <a
                            href="photolectureDisplay?photolecture_id={$data[lst].photolecture_id}&photo_id={$data[lst].photo_id}">
                            {$data[lst].photolecture_date}
                        </a>
                    </td>
                    <td>
                        <div class="center">{$data[lst].photolecture_width}x{$data[lst].photolecture_height}</div>
                    </td>
                    <td>{$data[lst].long_ref_mesuree}</td>
                    <td>{$data[lst].long_totale_reel}</td>
                    <td>
                        <div class="center">{$data[lst].age}</div>
                    </td>
                    {if $rights.manage == 1}
                    <td class="center">
